  ...
  return (
    <div className="sticky top-[180px] md:mx-[36px] bg-gradient-to-b from-[#28282C] to-[#2E2E34] rounded-[24px] border border-[#7F7F7F1A]">
      <div className="max-w-[1176px] mx-auto bg-[url('/images/Mobile-App-How-BG-2.webp')] bg-no-repeat bg-bottom bg-contain">
        <div className="text-center pt-16 flex flex-col gap-4 items-center w-[80%] md:w-[44%] mx-auto">
          ...
          <h2 className="w-full text-[#FFFFFF] font-semibold text-3xl md:leading-[67.2px] md:text-[56px] tracking-[-1.12px]">
            Fund your account and start investing
          </h2>
          <div className="w-full text-[#FFFFFF99] text-[14px] md:text-[16px] font-normal leading-[25.6px]">
          ...
          <div className="relative w-[70%] md:w-full z-20 border-t-[20px] border-x-[20px] rounded-x-[60px] rounded-t-[60px] border-[#7F7F7F1F]">
