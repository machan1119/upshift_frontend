  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-50 bg-gradient-to-b from-[#DDEDFA] to-[#FFFFFF00] pt-[180px] border-b-[1px] border-b-[#7F7F7F1A]">
      <div className="max-w-[1176px] mx-auto px-[10px]">
        <div className="z-[2] pb-[32px] bg-[800px_auto]">
        ...
        <div className="min-w-max border border-[#7F7F7F1A] rounded-[18px] p-6 bg-white flex flex-col gap-5">
          ...
          <textarea
            name="form_message"
            placeholder="Message"
            className="w-full h-[146px] p-3 rounded-[8px] border border-[#7F7F7F1A] text-[14px] text-black"
          />
