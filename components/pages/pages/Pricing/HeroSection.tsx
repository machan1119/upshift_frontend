        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="p-[34px] rounded-[12px] m-2 flex flex-col gap-3 grow">
            ...
            <div className="flex gap-2 items-center">
              <p className="text-[34px] md:text-[48px] leading-[48px] font-semibold text-black">
                $0
              </p>
            ...
            <div className="flex flex-col gap-2 pt-4">
              <div className="flex gap-[5px]">
                ...
                <p className="text-[14px] md:text-[16px] leading-[25.6px] text-[#11111199] font-normal">
            ...
            <p className="text-[14px] md:text-[16px] leading-[25.6px] text-[#11111199] font-normal my-auto">
            ...
            <div className="flex items-center justify-center">
              <Link
                href="#"
                className={`w-full md:w-max text-center text-[14px] md:text-[16px] leading-[16px] font-medium shadow-[0_2px_4px_0_rgba(0,10,31,0.2),_inset_0_6px_3px_-1px_rgba(255,255,255,0.2)] bg-black px-[20.8px] py-[11.2px] rounded-[12px] text-white`}
              >
                Get Started &gt;
              </Link>
            </div>
          ...
          <div className="p-[34px] rounded-[12px] m-2 flex flex-col gap-3 border border-primary grow">
            <h5 className="font-semibold text-[14px] md:text-[16px] leading-[25.6px] text-primary">
              Pro
            </h5>
            <div className="flex gap-2 items-center">
              <p className="text-[34px] md:text-[48px] leading-[48px] font-semibold text-black">
            ...
            <div className="flex items-center justify-center">
              <Link
                href="#"
                className={`w-full md:w-max text-center text-[14px] md:text-[16px] leading-[16px] font-medium shadow-[0_2px_4px_0_rgba(0,10,31,0.2),_inset_0_6px_3px_-1px_rgba(255,255,255,0.2)] bg-primary px-[20.8px] py-[11.2px] rounded-[12px] text-white`}
              >
                Choose Plan &gt;
              </Link>
            </div>
          ...
          <div className="p-[34px] rounded-[12px] m-2 flex flex-col gap-3 grow">
            <h5 className="font-semibold text-[14px] md:text-[16px] leading-[25.6px] text-[#1111119]">
              Premium
            </h5>
            <div className="flex gap-2 items-center">
              <p className="text-[34px] md:text-[48px] leading-[48px] font-semibold text-black">
            ...
            <div className="flex items-center justify-center">
              <Link
                href="#"
                className={`w-full md:w-max text-center text-[16px] leading-[16px] font-medium shadow-[0_2px_4px_0_rgba(0,10,31,0.2),_inset_0_6px_3px_-1px_rgba(255,255,255,0.2)] bg-black px-[20.8px] py-[11.2px] rounded-[12px] text-white`}
              >
                Get Started &gt;
              </Link>
            </div>
