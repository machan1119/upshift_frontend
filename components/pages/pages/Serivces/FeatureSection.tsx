    ...
    <section className="w-full bg-gray-50">
        ...
        <div className="max-w-[1176px] py-[100px] pr-[100px] mx-auto w-full flex gap-[60px] bg-[url('/images/Services-Features-BG-1.webp')] bg-contain bg-no-repeat bg-left">
          <div className="ml-[-64px] w-max flex gap-5 pr-10 items-center">
            <Image
              ...
              width={128}
              height={374}
              className="w-[128px] h-[374px] hidden lg:block z-10 shadow-[0px_2px_4px_0px_rgba(0,10,31,0.2)]  rounded-[8px]"
              priority
            />
            <Image
              ...
              width={420}
              height={402}
              className="w-[420px] h-[402px] hidden lg:block z-10 shadow-[0px_0px_0px_1px_rgba(127,127,127,0.1)]  rounded-[8px]"
              priority
            />
          </div>
      ...
      <div className="w-full border-b border-b-[#7F7F7F1A]">
        <div className="max-w-[1176px] mx-auto w-full flex justify-between bg-[url('/images/Services-Features-BG-2.webp')] bg-contain bg-no-repeat bg-bottom">
          <div className="md:w-[50%] w-full flex flex-col gap-4 justify-center p-10 md:p-20 border-r border-r-[#7F7F7F1A]">
            <div className="w-max border border-[8181812E] rounded-full px-[12px] py-[6px] shadow-[0px_2px_4px_0px_rgba(0,10,31,0.2)]">
              <p className="text-secondary font-medium text-[14px] leading-[16.8px]">
                Features
              </p>
          ...
          <div className="relative hidden lg:flex px-[100px] py-[90px] w-max gap-5 items-center">
            <Image
              src="/images/Services-Features-Image-3.webp"
              alt="Services-Features-Image-3"
              width={344}
              height={408}
              className="w-[344px] h-[408px] hidden lg:block z-10 shadow-[0px_2px_4px_0px_rgba(0,10,31,0.2)] rounded-[8px]"
              priority
            />
            <Image
              ...
              width={316}
              height={211}
              className="absolute w-[316px] h-[211px] hidden lg:block z-[8] rounded-[8px] left-[-100px]"
              priority
            />
            <Image
              ...
              width={244}
              height={200}
              className="absolute w-[244px] h-[200px] hidden lg:block z-[12] rounded-[8px] bottom-[150px] right-[-100px] border-primary border shadow-[0px_2px_4px_0px_rgba(0,10,31,0.2)]"
              priority
            />
          </div>
        </div>
      ...
      <div className="w-full border-b border-b-[#7F7F7F1A]">
        <div className="max-w-[1176px] mx-auto w-full flex justify-between">
          ...
          <div className="md:w-[55%] w-full flex flex-col gap-4 justify-center p-10 md:p-20">
            <div className="w-max border border-[8181812E] rounded-full px-[12px] py-[6px] shadow-[0px_2px_4px_0px_rgba(0,10,31,0.2)]">
              <p className="text-secondary font-medium text-[14px] leading-[16.8px]">
                Features
              </p>
