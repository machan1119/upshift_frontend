  ...
  return (
    <div className="w-full py-10 bg-gray-50 border-y border-y-[#7F7F7F1A]">
      <div className="mx-[36px] bg-gradient-to-b from-[#28282C] to-[#2E2E34] rounded-[24px] ">
        <div className="max-w-[1176px] mx-auto pb-[80px]">
          <div className="text-center pt-[80px] pb-[100px] flex flex-col gap-4 items-center w-[60%] mx-auto">
          ...
          <div className="w-full relative pricing-animation grid grid-cols-1 md:grid-cols-3 border-y border-[#7F7F7F1A]">
            <div className="p-[34px] rounded-[12px] m-2 flex flex-col gap-3 grow">
              ...
              <div className="flex gap-2 items-center">
                <p className="text-[48px] leading-[48px] font-semibold text-white">
                  $0
                </p>
              ...
              <div className="flex flex-col gap-2 pt-4">
                <div className="flex gap-[5px]">
                  ...
                  <p className="text-[16px] leading-[25.6px] text-white font-normal">
              ...
              <p className="text-[16px] leading-[25.6px] text-[#FFFFFF99] font-normal my-auto">
              ...
              <div className="flex items-center justify-center border border-[#313236]">
                <Link
                  href="#"
                  className={`w-full text-center text-[16px] leading-[16px] font-medium bg-[#313236] px-[20.8px] py-[14px] rounded-[10px] text-white`}
                >
                  Choose Plan &gt;
                </Link>
              </div>
